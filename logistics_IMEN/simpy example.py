...
main.config(bg="#fff")
logo = tk.PhotoImage(file = "C:/Users/USER/Documents/Jupyter Notebook/Logistics/Logistics_EDA/gate-simulation-master (1)/gate-simulation-master/images/LogoDattivo.png")
...
def Sellers(canvas, x_top, y_top):
    return QueueGraphics("C:/Users/USER/Documents/Jupyter Notebook/Logistics/Logistics_EDA/gate-simulation-master (1)/gate-simulation-master/images/group.gif", 25, "Seller", SELLER_LINES, canvas, x_top, y_top)

def Scanners(canvas, x_top, y_top):
    return QueueGraphics("C:/Users/USER/Documents/Jupyter Notebook/Logistics/Logistics_EDA/gate-simulation-master (1)/gate-simulation-master/images/person-icon.png", 18, "Scanner", SCANNER_LINES, canvas, x_top, y_top)
